...
public class DataProviderClass {
    ...
    public static Object[][] dataProviderNewUser() {
        return new Object[][]{{"testvk1@mail.ru", "VkFirst1","2"}, {"testvk2@mail.ru", "Vk Last1","2"}};
    }
    ...
    public static Object[][] dataProviderCreateCompany() {
        return new Object[][]{{"Company 1", "ООО","testvk2@mail.ru","testvk5@mail.ru","testvk1@mail.ru"},
    ...
    public static Object[][] dataProviderCreateCompanyWrongOwner() {
        return new Object[][]{{"Company 3", "ООО","testvk2@mail.ru","testvk5@mail.ru","testvk1_wrong@mail.ru"},
    ...
    public static Object[][] dataProviderCreateCompanyWithWrongType() {
        return new Object[][]{{"Company 1", "ОAО", "testvk2@mail.ru", "testvk5@mail.ru", "testvk1@mail.ru"},
                {"Company 2", "TOB", "testvk2@mail.ru", "testvk5@mail.ru", "testvk1@mail.ru"}};
    }
}