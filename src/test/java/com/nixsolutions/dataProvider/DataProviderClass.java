...
public class DataProviderClass {
    ...
    public static Object[][] dataProviderNewUser() {
        return new Object[][]{{"testvk11@mail.ru", "VkFirst11","2"}, {"testvk21@mail.ru", "Vk Last11","2"}};
    }
    ...
    public static Object[][] dataProviderLoginUser() {
        return new Object[][]{{"testvk11@mail.ru", "2"}, {"testvk21@mail.ru", "2"}};
    }
    ...
    public static Object[][] dataProviderCreateUserWithTask() {
        return new Object[][]{{"testvk51@mail.ru", "First Last name41", "First task", "description",
    ...
    public static Object[][] dataProviderCreateCompany() {
        return new Object[][]{{"Company 1", "ООО","testvk21@mail.ru","testvk51@mail.ru","testvk11@mail.ru"},
                {"Company 2", "ООО","testvk21@mail.ru","testvk51@mail.ru","testvk11@mail.ru"}};
    }

    @DataProvider(name = "data-provider-creation-company-wrong-owner")
    public static Object[][] dataProviderCreateCompanyWrongOwner() {
        return new Object[][]{{"Company 3", "ООО","testvk21@mail.ru","testvk51@mail.ru","testvk1_wrong@mail.ru"},
                {"Company 4", "ООО","testvk21@mail.ru","testvk51@mail.ru","testvk1_wrong@mail.ru"}};
    }

    @DataProvider(name = "data-provider-creation-company-without-users")
    public static Object[][] dataProviderCreateCompanyWithoutUsers() {
        return new Object[][]{{"Company 3", "ООО","","testvk3_notexist@mail.ru","testvk11@mail.ru"},
                {"Company 4", "ООО","testvk2_notexist@mail.ru","","testvk11@mail.ru"}};
    }
    ...
    public static Object[][] dataProviderCreateCompanyWithWrongType() {
        return new Object[][]{{"Company 1", "ОAО", "testvk21@mail.ru", "testvk51@mail.ru", "testvk11@mail.ru"},
                {"Company 2", "TOB", "testvk21@mail.ru", "testvk51@mail.ru", "testvk11@mail.ru"}};
    }
}